...
quantile(terror_selected_filtered_plus$country_population)

terror_selected_filtered_plus$tamanho_pais[terror_selected_filtered_plus$country_population<=8000000] <- "<=8000000"
terror_selected_filtered_plus$tamanho_pais[terror_selected_filtered_plus$country_population>8000000&terror_selected_filtered_plus$country_population<=20000000] <- ">8000000 and <=20000000"
terror_selected_filtered_plus$tamanho_pais[terror_selected_filtered_plus$country_population>20000000&terror_selected_filtered_plus$country_population<=30000000] <- ">20000000 and <=30000000"
terror_selected_filtered_plus$tamanho_pais[terror_selected_filtered_plus$country_population>30000000] <- ">30.000.000"
